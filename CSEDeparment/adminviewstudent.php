...
<head>
    ...
    <script type="text/javascript">
        ...
        function Ajaxfun()
        {
            ...
            var b = document.myform.sem.value;
            
            var strURL = "viewStudentAjax.php?batch="+a+"&sem="+b;
        ...
        function fun()
        {
            ...
            return confirm("Are you sure for remove this Student from CSE batch "+a+" "+b+"th sem");
        }
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby='StudentDropdown'>
						<li>
            				<a class="dropdown-item disabled" href="adminviewstudent.php">View Student</a>
            			</li>
            			<li>
...
{
    $qry = "select * from student where id=$id and rollno='$rn'";
    $resultset = mysqli_query($link,$qry);
    
    $r = mysqli_fetch_assoc($resultset); 
    
    $qry1 = "delete from student where id=$id and rollno='$rn'";
    $resultset1 = mysqli_query($link,$qry1);
    
    if($resultset1)
    {
        echo"<div class='h4 text-danger mb-3' style='text-align:center;'>Student $r[name] , Roll no.: $r[rollno] remeve from CSE batch $r[batch] , $r[semester] semester.</div>";
    }
}
?>
...
<div class="container-fluid">
	<div class="row p-4 justify-content-center">
		<div class="col-xl-3 col-lg-4 mb-3">
            <b class="h4">Choose Batch : </b>
            <input type="tel" name="batch" maxlength="4" required="true" placeholder="Enter Batch" />
        </div> 
		<div class="col-xl-3 col-lg-4 mb-3">
			<b class="h4">Choose Semester :</b>
            <select name='sem' onchange="Ajaxfun()" >
