			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            			...
            			<li><a class="dropdown-item active disabled" href="facultylogin.php">Faculty</a></li>
...
<div class="container-fluid text-danger mb-4 d-flex justify-content-center">
	<b class="h2"> Please fill the <i class="text-success">Faculty</i> Id and Password. </b>
</div>
...
<div class="container-fluid">
	<div class='container p-3 mx-auto'>
		...
		<div class="h1 text-primary d-flex justify-content-center mb-4"> FOR FACULTY </div>
		...
		<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-xs-4">
			<input type="tel" name="uid" placeholder="Enter Faculty Id" maxlength="4" required="true">
		</div>
...
if(isset($login))
{
    ...
    $qry = "select * from faculty where id='$uid' and password='$pwd' and (post!='Admin')";
    ...
    if($nr)
    {
        ...
        $_SESSION['FacultyId']=$r[id];
        $_SESSION['FacultyName']=$r[name];
        $_SESSION['FacultyProfile']=$r[profile];
        
        header("location:facultylanding.php");
    }
    else
    {
        echo "<center class='text-gray-dark h5'>Faculty Not found Please Enter valid Details</center>";
    }
