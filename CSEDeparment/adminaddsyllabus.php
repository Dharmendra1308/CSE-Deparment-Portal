...
<head>
    ...
    <script type="text/javascript">
    	...
    	function Ajaxfun()
        {
            ...
            var strURL = "addSyllabusAjax.php?sem="+a;
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby='SyllabusDropdown'>
            			...
            			<li>
            				<a class="dropdown-item disabled" href="#">Add Syllabus</a>
            			</li>
					</ul>
				</li>
...
<div class="container">
	...
	<div class="h2 text-success" style="text-align: center;">Add Syllabus</div>
...
if(isset($addsyllabus) and !empty($sname) and !empty($topics) )
{
    echo "<center><h3>CSE 6th Sem Syllabus.</h3></center><br />";
    
    $fn = "Syllabus/cse".$sem."syllabus.txt";
    
    $sn = "<center><dl style='width:70%;'><dt>".$sname."</dt><dd>".$topics."</dd></dl></center><br />";
    ...
    header("location:adminaddsyllabus.php");
}
